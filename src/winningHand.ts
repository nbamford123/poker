...
export const highCard = (
    ...
    for (let idx = hand1.length - 1; idx >= 0; idx--) {
        ...
        if (hand2[idx].number > hand1[idx].number)
            return WinningHand.SecondHand;
    }
...
export const winningHand = (
    ...
    return winningHand !== WinningHand.Tie
        ? winningHand
